...
# abs(): valor absoluto: si le paso un negativo, me devuelve el valor en positivo
abs(gravedad)
abs(docena)
...
# not: negado (no es estrictamente una comparación, pero va por ahí)
not docena == 12 # False
not docena == 10 # True


# varias comparaciones juntas
